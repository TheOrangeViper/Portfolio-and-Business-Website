    ...
    <main className={styles.main}>
      ...
      <div className={styles.center}>
          ...
          >
            ...
            <div className={styles.cardContent}>Check out my Linkedin profile over here!</div>
          </a>
          ...
          >
            ...
            <div className={styles.cardContent}>
              <iframe width="390" height="220" src="https://www.youtube.com/embed/videoseries?si=hguDW8u_2IP74oDT&amp;list=PLWa51KwS8CLM1pmV7TAUVFUFXeC8LVP8h" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
          </a>
